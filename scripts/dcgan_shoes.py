...
def train_mode(gen, dis, trainLoader, useNoise=False, beta1=0.5, WGAN=False):
	####### Define optimizer #######
...
if __name__=='__main__':
	...
	gen, dis = train_mode(gen, dis, trainLoader, useNoise=opts.useNoise, beta1=0.5, WGAN=opts.WGAN)
